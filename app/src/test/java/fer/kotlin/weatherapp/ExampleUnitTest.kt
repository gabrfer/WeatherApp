...
class ExampleUnitTest {
    ...
    fun addition_isCorrect() {
        ...
        val COMPLETE_URL: `val`
        String = "\$URL&api_key=\$API_KEY"

        val finalURL: `val`
        String = COMPLETE_URL.replace("_dateFrom", "2000-02-01T00:00:00UTC").replace("_dateTo", "2000-02-27T23:59:59UTC").replace("_station", "1082")
